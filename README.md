...
*This project is a fork of the awesome [packer-examples-for-vsphere](https://github.com/vmware-samples/packer-examples-for-vsphere) repository on GitHub. It has been modified to better support configuration to work better with Rancher, RKE, and RKE2. [vsphere-templates-for-rancher](This builds on https://github.com/phillipsj/vsphere-templates-for-rancher) which served as an excellent base.*
